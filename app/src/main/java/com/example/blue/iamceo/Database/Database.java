...
public class Database {
    public  static final   String DATA_NAME="CEODB.sqlite";
    public  static final   String TAB_NHANVIEN="NHANVIEN";
    public  static final   String TAB_THEMNHANVIEN="ThemNhanVien";
    public  static final   String TAB_DUAN="DuAn";
    public  static final   String TAB_TRUONGNHOM="TruongNhom";
    public  static final   String TAB_THEMDUAN="ThemDuAn";
